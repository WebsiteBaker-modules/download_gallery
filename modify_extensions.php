...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	...
	<body>
		<div class="modify_section">
			...
			<form name="modify_file_ext" method="post" action="<?php echo WB_URL; ?>/modules/download_gallery/save_extsettings.php<?php echo $token; ?>" onsubmit="return validateForm(this);" >
