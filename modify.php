...
<h2 style="float:left;"><?php echo get_menu_title($page_id); ?></h2>
...
<table id="DownloadGalleryFiles" style="width:100%" class="download_gallery">
<thead>
...
if(isset($groups_found) && $groups_found == false){
	echo '<p class="notification" style="text-align:center;">'.$MESSAGE['GROUPS_NO_GROUPS_FOUND'].'</p><br />';
}
...
foreach($list as $group){	
	...
	// inner LOOP
	if(!empty($list[$group['group_id']]['files'])){
