...
<div class="download_gallery_help">
	...
	<ul>
		...
		<li><code>File header</code> - This field will be displayed at the beginning of the download file list.
			<ul>
				...
				<li><code>[THRELEASED]</code> - The release date button of the list with sort function</li>
		...
		<li><code>Files loop</code> - This section will be repeated each time a download is found. Within this field one can use the following codes:
			<ul>
				...
				<li><code>[DATE]</code> - The date on which the download file has been last modified (found out automagically)</li>
				<li><code>[RELEASED]</code> - The date on which the file has been released (set by admin to any date he wants)</li>
	...
	<strong>Version 2.61 modified (02-01-2013) by Frank Heyne</strong>
		<ul>
			<li><strong>Added</strong> new field description for release date in help file, thanks to Lothar Matter</li>
		</ul>
	<hr />
	
	<strong>Version 2.60 modified (01-18-2013) by Frank Heyne</strong>
		<ul>
			<li><strong>Added</strong> new field for release date of the document</li>
		</ul>
	<hr />
	
	<strong>Version 2.51 modified (01-04-2013) by Frank Heyne</strong>
		<ul>
			<li><strong>Fixed</strong> Updated NL language file, thanks to Andr� de Winkel</li>
			<li><strong>Fixed</strong> Bug fix in modify_settings.php, thanks to Andr� de Winkel</li>
		</ul>
	<hr />
	
	<strong>Version 2.50 modified (10-01-2012) by Frank Heyne</strong>
		<ul>
			<li><strong>Fixed</strong> Upload does now work under Lepton 1.1</li>
			<li><strong>Fixed</strong> Upload does only allow registered file types now</li>
		</ul>
	<hr />

	<strong>Version 2.40 modified (12-09-2011) by Frank Heyne</strong>
		<ul>
			<li><strong>Added</strong> Option to decide whether "Save File" dialogue is shown or file will become opened in the browser</li>
		</ul>
	<hr />
	
	<strong>Version 2.30 modified (08-07-2011) by Frank Heyne</strong>
		<ul>
			<li><strong>Fixed</strong> THEME_URL</li>
			<li><strong>Added</strong> Compatibility with Lepton</li>
			<li><strong>Added</strong> Possibility to reset download counter</li>
		</ul>
	<hr />
